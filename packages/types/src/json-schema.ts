...
export function getCreateJSStackConfigJsonSchema() {
  return z.toJSONSchema(CreateJSStackConfigSchema);
}
...
export function getAllJsonSchemas() {
  return {
    ...
    betterTStackConfig: getCreateJSStackConfigJsonSchema(),

...
// Expo SDK 55 requires TypeScript ~5.9.x. Pin explicitly so the generic
// `typescript` entry in dependencyVersionMap (which tracks the latest major)
// cannot leak into the native app via hoisting or future edits.

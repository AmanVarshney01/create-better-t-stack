...
export const dependencyVersionMap = {
  ...
  "@clerk/tanstack-react-start": "^0.29.8",
  "@clerk/clerk-expo": "^2.19.29",
  ...
  "@mikro-orm/sqlite": "^6.6.8",
  "@mikro-orm/postgresql": "^6.6.8",
  "@mikro-orm/mysql": "^6.6.8",
  "@mikro-orm/better-sqlite": "^6.6.8",

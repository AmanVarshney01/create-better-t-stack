...
create-js-stack --database mongodb --orm drizzle

# ✅ Valid - MongoDB with Mongoose
create-js-stack --database mongodb --orm mongoose
```
...
create-js-stack --runtime workers --backend express

# ✅ Valid - Workers with Hono
create-js-stack --runtime workers --backend hono --database sqlite --orm drizzle --db-setup d1

# ✅ Also valid - Workers with Prisma (D1)
create-js-stack --runtime workers --backend hono --database sqlite --orm prisma --db-setup d1
```
...
create-js-stack --frontend nuxt --api trpc

# ✅ Valid - Nuxt with oRPC
create-js-stack --frontend nuxt --api orpc
```
...
create-js-stack --frontend next tanstack-router
...
create-js-stack --auth better-auth --database none

# ✅ Valid - Better-Auth with full stack
create-js-stack --auth better-auth --database postgres --orm drizzle --backend hono

# ✅ Valid - Clerk with Hono
create-js-stack --auth clerk --backend hono --frontend tanstack-router

# ✅ Valid - Clerk with fullstack Next.js
create-js-stack --auth clerk --backend self --frontend next

# ❌ Invalid - Clerk with Astro
create-js-stack --auth clerk --backend self --frontend astro
```
...
```bash
# Fix by using Hono
create-js-stack --runtime workers --backend hono
```

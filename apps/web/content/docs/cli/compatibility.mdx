...
| Frontend          | tRPC Support | oRPC Support | CONNECTRPC Support | Notes              |
| ----------------- | ------------ | ------------ | ------------------ | ------------------ |
...
**CONNECTRPC** requires backend **Express** or **Fastify** (not Hono or Elysia).

```bash
# ❌ Invalid - Nuxt with tRPC
create-better-t-stack --frontend nuxt --api trpc

# ✅ Valid - Nuxt with oRPC or CONNECTRPC
create-better-t-stack --frontend nuxt --api orpc
create-better-t-stack --frontend nuxt --api connectrpc --backend express

# ❌ Invalid - CONNECTRPC with Hono
create-better-t-stack --api connectrpc --backend hono

# ✅ Valid - CONNECTRPC with Express
create-better-t-stack --api connectrpc --backend express
```

...
- `sentry`: Error monitoring and tracing for supported web, native, and server applications

```bash
create-better-t-stack --addons sentry biome husky
```

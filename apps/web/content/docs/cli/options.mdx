...
- `mcp`: Install recommended third-party MCP servers for your selected stack

**Note:** This addon installs MCP servers for tools/editors. To run Better-T-Stack itself as an MCP server, use `create-better-t-stack mcp`.

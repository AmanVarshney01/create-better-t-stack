...
description: Use Create-JS-Stack programmatically in your Node.js applications
---

## Overview

You can call Create-JS-Stack directly from TypeScript/JavaScript without shelling out to the CLI.

The programmatic API is exported from `create-js-stack` and is designed for automation tools, internal generators, and scripted workflows.
...
Add addons to an existing Create-JS-Stack project.
...
```typescript
import { createVirtual } from "create-js-stack";

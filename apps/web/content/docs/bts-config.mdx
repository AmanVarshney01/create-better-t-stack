...
- Values mirror what you selected during project creation. `api` may be `trpc`, `orpc`, `connectrpc`, or `none`.
- `reproducibleCommand` contains the exact command to recreate this project
- The file may be updated when you run `add` (currently: addons)

...
```json
{
  ...
  "addons": ["<pwa|tauri|starlight|fumadocs|biome|lefthook|husky|ruler|mcp|turborepo|nx|ultracite|oxlint|opentui|wxt|skills|none>"] ,
...
```json
{
  "scripts": {
    ...
    "check-types": "nx run-many -t check-types --all",

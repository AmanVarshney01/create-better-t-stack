...
import { ImNpm as NpmIcon } from "react-icons/im";
import { SiPnpm as PnpmIcon } from "react-icons/si";
...
<Tabs groupId="installtab" defaultValue="npm" persist>
  <TabsList>
    ...
    <TabsTrigger value="bun" className="flex items-center gap-2">
      <img src="/icon/bun.svg" alt="bun" className="size-6" />
      bun
    </TabsTrigger>
  </TabsList>

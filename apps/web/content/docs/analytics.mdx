...
<Tabs groupId="installtab" defaultValue="npm" persist>
  ...
  <TabsContent value="npm">
    ```bash BTS_TELEMETRY_DISABLED=1 npx create-better-t-stack@latest ```
  </TabsContent>
  <TabsContent value="pnpm">
    ```bash BTS_TELEMETRY_DISABLED=1 pnpm create better-t-stack@latest ```
  </TabsContent>
  <TabsContent value="bun">
    ```bash BTS_TELEMETRY_DISABLED=1 bun create better-t-stack@latest ```
  </TabsContent>
</Tabs>

---
title: Quick Start
description: Create your first Create-JS-Stack project in minutes
---
...
```npm
npm create create-js-stack@latest
```
...
```npm
npm create create-js-stack@latest --yes
```
...
```npm
npm create create-js-stack@latest builder
```
...
```npm
npm create create-js-stack@latest my-webapp \
...
```npm
npm create create-js-stack@latest my-api \
  --frontend tanstack-router \
  --backend convex \
  --auth clerk
```
...
```npm
npm create create-js-stack@latest my-native \
...
```npm
npm create create-js-stack@latest my-workspace \
  --frontend none \
  --backend none
```
...
<Cards>
  ...
  <Card href="/docs/cjs-config" title="cjs.jsonc">

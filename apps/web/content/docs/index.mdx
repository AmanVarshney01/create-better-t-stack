...
### ConnectRPC with Express

```npm
npm create better-t-stack@latest my-grpc-app \
  --frontend tanstack-router \
  --backend express \
  --api connectrpc \
  --database sqlite \
...
- `--payments`: polar, none
- `--addons`: turborepo, pwa, tauri, biome, lefthook, husky, starlight, fumadocs, ultracite, oxlint, ruler, mcp, opentui, wxt, skills, none

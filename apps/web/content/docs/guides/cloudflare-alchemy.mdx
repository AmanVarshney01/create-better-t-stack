...
- web: Next.js, Nuxt, Astro, React Router, TanStack Start, SvelteKit, and Solid 2
...
stack supplies explicit production artifacts for the remaining frameworks: Solid 2's Nitro
...
for React Router, TanStack Router, TanStack Start, and Solid 2. Next.js and stable SvelteKit keep
...
```bash
# Full-stack Solid 2 on Prisma with PlanetScale MySQL

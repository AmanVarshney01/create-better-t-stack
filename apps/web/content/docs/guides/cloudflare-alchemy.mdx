...
<Callout type="info">
  Generated projects pin `alchemy@2.0.0-beta.78` with `effect@4.0.0-rc.115` exactly. The matching
  framework source package is installed in the web workspace that Alchemy loads it from.
</Callout>

import { C as m } from "./check-DWEmbU_d.js";
import { c as s, j as e, G as d, r as o, L as i } from "./main-BHLV-i_6.js";
/**
      ...
      children: [
          ...
          children: [
            e.jsxs("div", {
              ...
              children: [
                ...
                e.jsx("span", { className: "hidden h-4 w-px bg-border sm:block" }),
                e.jsx("span", {
        ...
        e.jsx("div", {
          ...
          children: e.jsxs("p", {
            ...
            children: [new Date().getFullYear(), " Better Fullstack"],
          }),
        }),
      ],
    }),
  ...
  switch (a) {
    ...
    case "pnpm":
      return e.jsxs("svg", {
        ...
        children: [
          e.jsx("title", { children: "pnpm" }),
          e.jsx("path", { d: "M30,10.75H21.251V2H30Z", style: { fill: "#f9ad00" } }),
          e.jsx("path", { d: "M20.374,10.75h-8.75V2h8.75Z", style: { fill: "#f9ad00" } }),
          e.jsx("path", { d: "M10.749,10.75H2V2h8.749Z", style: { fill: "#f9ad00" } }),
          e.jsx("path", { d: "M30,20.375H21.251v-8.75H30Z", style: { fill: "#f9ad00" } }),
          e.jsx("path", { d: "M20.374,20.375h-8.75v-8.75h8.75Z", style: { fill: "#fff" } }),
          e.jsx("path", { d: "M20.374,30h-8.75V21.25h8.75Z", style: { fill: "#fff" } }),
          e.jsx("path", { d: "M30,30H21.251V21.25H30Z", style: { fill: "#fff" } }),
          e.jsx("path", { d: "M10.749,30H2V21.25h8.749Z", style: { fill: "#fff" } }),
        ],
      });
    case "bun":
      return e.jsxs("svg", {
...
function k() {
  const [a, t] = o.useState(!1),
    ...
    p = () => {
      (navigator.clipboard.writeText(l[n]), t(!0), setTimeout(() => t(!1), 2e3));
    };
  return e.jsxs("div", {
          ...
          e.jsxs("div", {
            ...
            children: [
              e.jsxs("h1", {
                ...
                children: [
                  e.jsx("span", { className: "block text-foreground", children: "Better" }),
                  e.jsx("span", {
                    className:
                  ...
                  e.jsxs("div", {
                    ...
                    children: [
                      ...
                      e.jsx("div", {
                        ...
                        children: ["bun", "pnpm", "npm"].map((r) =>
                          e.jsxs(
                            "button",
                            {
                              type: "button",
                              onClick: () => x(r),
                              className: `flex items-center gap-1.5 px-2 py-1 text-xs font-medium uppercase tracking-wider transition-all ${n === r ? "bg-foreground text-background" : "text-muted-foreground hover:text-foreground"}`,
                              children: [e.jsx(N, { pm: r, className: "h-3 w-3" }), r],
                            },
                            r,
                          ),
                        ),
            ...
            e.jsxs("div", {
              ...
              children: [
                e.jsxs("a", {
                  ...
                  children: [e.jsx(j, { className: "h-4 w-4" }), "LinkedIn"],
                }),
                e.jsxs("a", {
                  ...
                  className:
                    "inline-flex items-center gap-2 border border-border px-4 py-3 text-sm font-medium uppercase tracking-wider text-muted-foreground transition-all hover:border-foreground hover:text-foreground",
                  children: [e.jsx(v, { className: "h-4 w-4" }), "X"],
                }),
                e.jsxs("a", {
                  ...
                  className:
                    "inline-flex items-center gap-2 border border-border px-4 py-3 text-sm font-medium uppercase tracking-wider text-muted-foreground transition-all hover:border-foreground hover:text-foreground",
                  children: [e.jsx(d, { className: "h-4 w-4" }), "GitHub"],
                }),
              ],
            }),
            e.jsxs("a", {
...
function B() {
  return e.jsxs("main", {
    ...
    children: [e.jsx(k, {}), e.jsx(y, {}), e.jsx(w, {})],
  });
}
